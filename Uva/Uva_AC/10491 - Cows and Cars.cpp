/***************************************************
 * Problem Name : 10491 - Cows and Cars.cpp
 * Problem Link : https://onlinejudge.org/external/104/10491.pdf
 * OJ           : Uva
 * Verdict      : AC
 * Date         : 2020-08-17
...
int main () {
    ...
    while (cin >> NCOWS >> NCARS >> NSHOW) {
        ...
        cout << ( (double) NCARS * (NCOWS + NCARS - 1) ) / ( (NCOWS + NCARS) *
                (NCOWS + NCARS - NSHOW - 1) ) << "\n";
    }
